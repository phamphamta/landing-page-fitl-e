        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingPlans.map((plan, key) => (
            <div key={key} className="relative group h-full">
              <div className="bg-gradient-to-r from-teal-500 to-yellow-500 p-1 rounded-3xl h-full">
                <div
                  ...
                  {plan.bestValue && (
                    <div
                      className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary
                                                    ...
                                                    px-3 py-1 rounded-full bg-gradient-to-r from-teal-500 to-yellow-500 ml-2"
                    >
                      Best Value
                    </div>
                  )}
