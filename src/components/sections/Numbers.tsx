      ...
      <Container className="flex justify-center align-center">
        ...
        >
          <div className="text-center px-5">
            ...
            <p className="mt-2 text-heading-3"> Workout Programs</p>
          </div>
          <div className="text-center px-5">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-4xl text-heading-1">
              {" "}
          ...
          <div className="text-center px-5">
            ...
            <p className="mt-2 text-heading-3"> App Uptime</p>
          </div>
          <div className="text-center px-5">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-4xl text-heading-1">
              {" "}
            ...
            <p className="mt-2 text-heading-3"> Years of Health Expertise</p>
          </div>
        </div>
      </Container>
    </section>
