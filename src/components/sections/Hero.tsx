      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
            Empower Your Health
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-yellow-500 ml-2">
              with FitLife{" "}
            </span>
          </h1>
          <Paragraph className="mt-8">
            Our smart fitness app seamlessly integrates into your daily routine
            to deliver personalized workout plans, real‑time progress tracking,
            and nutrition guidance. Experience a future where your health goals
            are achieved smarter, faster, and more efficiently.
          </Paragraph>
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
          <img
            src="public/assets/picture1.jpg"
            alt="Hero image"
            width={2350}
            height={2359}
